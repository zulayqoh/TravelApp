  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AppCubit, AppCubitState>(builder: (context, state) {
      if (state is LoadedState) {
        final exampleData = state.exampleData;
              ...
              children: [
                ...
                Align(
                  ...
                  child: TabBar(
                    ...
                    labelPadding:
                        EdgeInsets.symmetric(horizontal: AppDimension.width25),
                ...
                Container(
                  margin: EdgeInsets.only(
                      left: AppDimension.width20, top: AppDimension.height20),
                ...
                Container(
                  margin: EdgeInsets.symmetric(
                      ...
                      vertical: AppDimension.height5),
                  child: Align(
                    alignment: Alignment.topLeft,
                    child: AppMediumText(
                      text: exampleData[0].name,
                      color: Colors.black,
                      size: AppDimension.font33 / 2,
                    ),
                  ),
                ...
                Container(
                  margin: EdgeInsets.only(
                      left: AppDimension.width20, top: AppDimension.height5),
                  width: double.maxFinite,
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (_, index) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius:
                                BorderRadius.circular(AppDimension.width10),
                            image: DecorationImage(
